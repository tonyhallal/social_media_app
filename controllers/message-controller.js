/***********************************************************************************************************************
 ...
 Author: Tony Hallal
 Date: 14/11/2023
 Description: handles messages read and delete operations. Handles validation and delegates to the message
...
export const deleteMessage = async (req, res) => {
    try {
        ...
        res.status(201).send(await MessageService.removeMessage(message_id));
    } catch (err) {
